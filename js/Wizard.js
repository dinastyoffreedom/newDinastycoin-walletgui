...
//    var forkBlock = _nettype == "Mainnet" ? 1009827 : _nettype == "Testnet" ? 624634 : 32000;
    ...
    var secondsPerBlock;
    // before dinastycoin's birth
    if (requestedTime < dinastycoinBirthTime){
        console.log("Calculated blockchain height: 0, requestedTime < dinastycoinBirthTime " );
        return 0;
    }
    // time between during v1
    if (requestedTime > dinastycoinBirthTime && requestedTime < forkTime){
        approxBlockchainHeight = Math.floor((requestedTime - dinastycoinBirthTime)/secondsPerBlockV1);
