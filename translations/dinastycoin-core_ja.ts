...
Mining also gives you a small chance to earn some Dinastycoin. Your computer will create hashes looking for block solutions. If you find a block, you will get the associated reward. Good luck!</source>
        <translation>自分のコンピュータでマイニングをすることでDinastycoinネットワークをより強固にできます。多くの人がマイニングをすればするほど、攻撃はより難しくなります。

マイニングをするとDinastycoinが手に入ることがあります。コンピュータはブロックの解となるハッシュ値を生成し、もしブロックを見つけたら報酬が手に入ります。グッドラック！</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>第三者がリング内に既知の使用済みインプットを見つけられないことは、Dinastycoinトランザクションのどのインプットが使用されたのかを隠すために必要です。もし見つけられるとリング署名による保護は弱まります。もし1つのインプットを除いてすべてが使用済みだと知られている場合、実際に使用されたインプットは明らかとなり、Dinastycoinが使っている3つの主要なプライバシー保護レイヤーのうちの1つであるリング署名の効果が失われてしまいます。&lt;br&gt;トランザクションでそれらのインプットを避けるため、既知の使用済みインプットのリストを用いてそれらを新規のトランザクションで使用しないようにできます。このようなリストはDinastycoinプロジェクトによって保守されdinastycoin.comのウェブサイトで公開されており、ここではこのリストをインポートすることができます。&lt;br&gt;あるいはdinastycoin-blockchain-mark-spent-outputsというツールを使い、Dinastycoinのブロックチェーン(およびキーを再利用するDinastycoinクローンのブロックチェン)を自分でスキャンして既知の使用済みアウトプットのリストを生成できます。&lt;br&gt;</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Dinastycoinへようこそ。</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Dinastycoin GUIの言語を変更。</translation>
    </message>
    <message>
...
入力する必要があるでしょう。</translation>
    ...
    <message>
        ...
        <translation>Dinastycoinの送金に成功しました: %1 トランザクション</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>新しいバージョンの Dinastycoin v.%1 が利用可能です。&lt;br&gt;&lt;br&gt;ダウンロード:&lt;br&gt;%2&lt;br&gt;&lt;br&gt;SHA256ハッシュ:&lt;br&gt;%3</translation>
    </message>
    <message>
        <location filename="../main.qml" line="2172"/>
        <source>New version of Dinastycoin is available. Check out dinastycoin.com</source>
        <translation>新しいバージョンのDinastycoinが利用可能です。dinastycoin.comをチェックしてください</translation>
    </message>
    <message>
