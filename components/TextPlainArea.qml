...
TextArea {
    ...
    states: [
        State {
            name: "black";
            when: textArea.themeTransition && DinastycoinComponents.Style.blackTheme
            PropertyChanges {
                target: textArea
                color: {
                    return textArea.colorBlackTheme ? textArea.colorBlackTheme : DinastycoinComponents.Style._b_defaultFontColor
                }
            }
        }, State {
            name: "white";
            ...
            PropertyChanges {
                target: textArea
                color: {
                    return textArea.colorWhiteTheme ? textArea.colorWhiteTheme : DinastycoinComponents.Style._w_defaultFontColor
                }
            }
        }
    ]
